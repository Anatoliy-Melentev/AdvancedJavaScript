<template>
  <div class="header__card-menu card-menu">
    ...
    <div class="card-menu__total-sum">
      <btn-link class="card-menu__go-to-cart-btn" :color="'blank'" :route="cartpath">Go to the cart</btn-link>
      <div>
        <span class="card-menu__total-text">Total sum: </span>
        <span class="card-menu__total-price" id="total-price">{{ price }}</span>
      </div>
    </div>
  </div>
</template>
